...
# 4. ПАЛИТРА ИЗ ИЗОБРАЖЕНИЯ (21 оттенок от самого темного к самому светлому)
discrete_colors = [
...
<style>
    ...
    .cell-wrapper:hover .grid-cell {
        ...
        /* Мягкое натуральное свечение вместо неонового */
        box-shadow: 0px 4px 12px rgba(112, 204, 115, 0.45); 
    }
    .grid-cell-empty {
    ...
    /* Цвет выделения текста в подсказке теперь гармонирует с палитрой */
    .custom-tooltip b { color: #80d582; }
